...
const Navbar = ({user, handleSignOut, setIsLoggedIn, isLoggedIn}) => {
  ...
  return (
    <div className="w-full h-20 shadow-xl bg-[#220a2e] z-[100]">
      ...
      <button onClick={handleSignOut} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.0 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
      ...
      <button onClick={handleSignOut} type="button" className="rounded-full h-[50px] ml-[110%] bg-[#412a4c]">
                Sign out
              </button>
                    </ul>
                </div>
